...
\item Pleno conhecimento em  \textit{data mining}, \textit{data warehouse}, \textit{machine learning} e algoritmos de alta performance.
...
\item Forte conhecimento em desenvolvimento MVC e Webservices;
\end{itemize}
...
{\small \\
 ...
 \subitem - Linguagens: JAVA (SERVLET; JSP + JSON), Jquery, NodeJS, PostgreSQL.\\
}
...
{\small \\  
  ...
  \subitem - Principais linguagens {HTML/CSS, HTML5, C\#, .NET, JavaScript (frameworks: Jquery [JSon], JqueryUI), SQLServer}, ambiente Windows (servidores e estações).
}  
...
{\small \\ 
  ...
  \subsubitem - Linguagens {C\#,.NET, HTML/CSS, AJAX(JavaScript + XML), SQLServer}, ambiente Windows.
